...
function SignUpForm() {
    ...
    console.log('filtereddata Signup form ', filterdata.LoginUser.LoginUser.email)
    // const currLoginUser = useSelector((state) => filterdata.LoginUser)
    filterdata = filterdata.Company.find((v) => v.email === filterdata?.LoginUser?.LoginUser?.email)
